            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">Perbarui Pembayaran <i class="bi bi-check"></i></button>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="payment_method" id="payment_method" required>
                                                <option {{ $purchasePayment->payment_method == 'Cash' ? 'selected' : '' }}
                                                    value="Cash">Tunai</option>
                                                <option
                                                    {{ $purchasePayment->payment_method == 'Credit Card' ? 'selected' : '' }}
                                                    value="Credit Card">Kartu Kredit</option>
                                                <option
                                                    {{ $purchasePayment->payment_method == 'Bank Transfer' ? 'selected' : '' }}
                                                    value="Bank Transfer">Transfer Bank</option>
                                                <option
                                                    {{ $purchasePayment->payment_method == 'Cheque' ? 'selected' : '' }}
                                                    value="Cheque">Cek</option>
