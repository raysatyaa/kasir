                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="barcode_symbology">Symbology Barcode <span
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_stock_alert">Kuantitas Peringatan <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_unit">Satuan <i class="bi bi-question-circle-fill text-info"
                                                data-toggle="tooltip" data-placement="top"
                                                title="Teks singkat ini akan ditempatkan setelah Kuantitas Produk."></i>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="image">Gambar Produk <i class="bi bi-question-circle-fill text-info"
                                        data-toggle="tooltip" data-placement="top"
                                        title="Maksimal File: 3, Ukuran File Maksimal: 1MB, Ukuran Gambar: 400x400"></i></label>
