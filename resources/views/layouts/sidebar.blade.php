<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show {{ request()->routeIs('app.pos.*') ? 'c-sidebar-minimized' : '' }}"
    ...
    <div class="c-sidebar-brand d-md-down-none">
        <a href="{{ route('home') }}">
            <img class="c-sidebar-brand-full" src="{{ asset('images/logo.png') }}" alt="Logo Situs" width="110">
            <img class="c-sidebar-brand-minimized" src="{{ asset('images/logo.png') }}" alt="Logo Situs" width="40">
        </a>
    </div>
