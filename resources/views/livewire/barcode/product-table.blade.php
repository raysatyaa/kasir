        ...
        <div class="card-body">
                    ...
                    <thead>
                        <tr class="align-middle">
                            ...
                            <th class="align-middle">
                                Kuantitas <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip"
                                    data-placement="top" title="Maksimal Kuantitas: 100"></i>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div class="mt-3">
                <button wire:click="generateBarcodes({{ $product }}, {{ $quantity }})" type="button"
                    ...
                    <i class="bi bi-upc-scan"></i> Buat Barcode
                </button>
            </div>
        </div>
    </div>
